...
const features = [
  ...
  },
  {
    ...
    description: "Save hours of manual work and focus on the best-fit talent.",
  },
];
...
const HeroSection = () => {
  ...
  return (
    <>
      ...
      <motion.img
        src="https://img.freepik.com/free-vector/documents-concept-illustration_114360-138.jpg"
      ...
      >
        <button
          className="bg-brand-500 hover:bg-brand-600 text-white font-semibold py-3 px-8 rounded-full shadow-lg transition duration-300 mb-16"
...
const PromoText = () => (
  <motion.p
    className="max-w-2xl text-gray-700 dark:text-gray-300 text-base md:text-lg px-4 mb-12"
    initial={{ opacity: 0 }}
    animate={{ opacity: 1 }}
    transition={{ delay: 1, duration: 1 }}
  >
    Whether you're part of a growing startup or an enterprise HR team, Evalix is
    designed to supercharge your recruitment process and help you hire the right
    people—faster and smarter.
    <br />
...
const HomePage: React.FC = () => {
  return (
    <div className="flex flex-col min-h-screen">
      <div className="flex-grow flex flex-col items-center justify-center px-4 py-12 text-center bg-white dark:bg-gray-900 transition-colors duration-300">
        <HeroSection />
        <FeatureList />
        <PromoText />
      </div>
